export default function HowItWorks() {
  const steps = [
    { number: '1', title: 'Join the List', desc: 'Reserve your spot as a Founder today.' },
    { number: '2', title: 'Get Your Invite', desc: "You'll get priority access to the V1 launch." },
    { number: '3', title: 'Lock In Your Rate', desc: 'Enjoy Idunn and your exclusive $25/mo rate, forever.' },
  ];
